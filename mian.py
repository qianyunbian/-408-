    ...
    def dropEvent(self, e):
        ...
        if source_index != -1 and source_index != target_index:
            ...
            if target_index < len(self.buttons):
                ...
                # Also swap in the underlying actions list
                self.actions[source_index], self.actions[target_index] = \
                    self.actions[target_index], self.actions[source_index]
            else:
        ...
        self._relayout_buttons()
        # Save the updated order to config
        self.update_config_hierarchy()
